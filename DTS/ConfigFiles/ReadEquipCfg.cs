...
namespace DTS.ConfigFiles
{
    public class ReadEquipCfg
    {
        ...
        public void SetValue(Dictionary<string, DTSEquip> existChannels)
        {
            ...
            {
                string value = "ChannelCount = " + existChannels[newkeys[i]].ChannelCount + ";" + "SampleInterval = " + (existChannels[newkeys[i]].SampleInterval).ToString("F2") +";"+ "Port = " + existChannels[newkeys[i]].tcpServer._port + ";";
